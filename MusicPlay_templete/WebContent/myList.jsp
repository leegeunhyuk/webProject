										...
										<td>
											<table>
												<tr>
													...
													<td><span class="spanTitle">${music.name }</span><a class="btn btn-xs btn-default"
														href="detail.do"><b>i</b></a></td>
												</tr>
												<tr>
													<td><p class="pAlbum">${music.artist } - ${music.album }</p></td>
												</tr>
											</table>
										<td><a class="btn btn-xs btn-danger btnPlay" href="delete.do?id=${music.id }"><b>
													X </b></a></td>
									</tr>
								</c:forEach>
							</c:otherwise>
